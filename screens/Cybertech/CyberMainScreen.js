...
export default function CyberMainScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Welcome to CyberTech</Text>
        <Text style={styles.subtitle}>
          Discover CyberTech, see it, and feel{'\n'}it in your own hands
        </Text>

        <TouchableOpacity
          style={styles.nextButton}
          onPress={() => navigation.navigate('Cyber2ndScreen')}
        >
