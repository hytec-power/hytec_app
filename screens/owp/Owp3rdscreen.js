...
export default function Owp3rdscreen({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={[styles.section, styles.rowSection]}>
          ...
          <View style={styles.imageContainer}>
            ...
            <Image
              source={require('../../assets/owp/mission.png')}
        ...
        <View style={[styles.section, styles.rowSection]}>
          <View style={styles.imageContainer}>
            ...
            <Image
              source={require('../../assets/owp/vision.png')}
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('Owp')}
      >
