...
export default function HomeScreen() {
  ...
  const categories = [
    { id: '1', name: 'E-Hytec', icon: require('../assets/images/e-hytec.png'), screen: 'EhytecMainscreen' },
    { id: '2', name: 'OWP', icon: require('../assets/images/owp.png'), screen: 'OwpMainscreen' },
    { id: '3', name: 'Cyber Tech', icon: require('../assets/images/cybertech.png'), screen: 'CyberMainScreen' },
  ];
  ...
  const handleCategoryPress = (item) => {
    if (item.screen) {
      ...
      console.warn('No screen or URL defined for:', item.name);
    }
  };
